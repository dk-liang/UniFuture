...
from unifuture.modules.autoencoding.regularizers import AbstractRegularizer
from unifuture.modules.ema import LitEma
from unifuture.util import default, get_obj_from_str, instantiate_from_config
...
class AbstractAutoencoder(LightningModule):
    ...
    def apply_ckpt(self, ckpt: Union[None, str, dict]):
        if ckpt is None:
            ...
            ckpt = {
                "target": "unifuture.modules.checkpoint.CheckpointEngine",
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            ...
            decoder_config={
                "target": "unifuture.modules.diffusionmodules.model.Decoder",
                "params": ddconfig
            },
            **kwargs
        )
...
class AutoencoderKL(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        super().__init__(
            regularizer_config={
                "target": (
                    "unifuture.modules.autoencoding.regularizers.DiagonalGaussianRegularizer"
                )
            },
            **kwargs
        )
