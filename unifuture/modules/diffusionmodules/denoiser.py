...
class Denoiser(nn.Module):
    ...
    def forward(
        ...
        network_output = network(noised_input * c_in, c_noise, cond, cond_mask, self.num_frames)
        if isinstance(network_output, (tuple, list)):
            network_output, depth_output = network_output
        else:
            depth_output = None

        return (network_output * c_out + noised_input * c_skip), depth_output
