"""
Adapted from [https://github.com/YingqingHe/LVDM/blob/main/scripts/fvd_utils/fvd_utils.py], 
          or [https://github.com/songweige/TATS/blob/main/tats/fvd/pytorch_i3d.py]
"""
...
from .meta import MAX_BATCH, TARGET_RESOLUTION
